...
.PHONY: build
build:
	docker build -t digitalmarketplace-aws-user-frontend-http --build-arg DM_APP_NAME=user-frontend -f docker-aws/Dockerfile.http .
	docker build -t digitalmarketplace-aws-user-frontend-wsgi -f docker-aws/Dockerfile.wsgi .
